...
export class InstanceValidator {
  ...
  _validateSchema(rawAttribute, field, value) {
    if (rawAttribute.allowNull === false && (value === null || value === undefined)) {
      const association = Object.values(this.modelInstance.constructor.associations).find(association => association.constructor.name === BelongsTo.name && association.foreignKey === rawAttribute.fieldName);
